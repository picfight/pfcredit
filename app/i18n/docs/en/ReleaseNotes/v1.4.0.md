This pfcredit release has been mostly dedicated to fixing nagging issues
...
## New features
  ...
  (instead of the old v1). Given that after [DCP-0001](https://github.com/picfight/dcps/blob/master/dcp-0001/dcp-0001.mediawiki) the 
