...
the ability to create transactions in picfight coinsiton and then sign them with the
...
launch of picfightiton. We have added an initial proof of concept for a dark theme
...
## New features
  ...
  - PicFightiton has switched to using the ticketbuyer v2 service from the wallet 
  ...
  - Whenever a panic is detected by decrediton in pfcd or pfcwallet, users are now
...
## Other improvements
  ...
  PFC/kB as the default.  Any transaction or ticket created in picfight coinsiton or 
  ...
  - Transactions are now decoded within picfight coinsiton instead of being sent back to 
