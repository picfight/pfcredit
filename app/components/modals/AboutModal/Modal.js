  ...
  <Modal className="about-modal" {...{ show, onCancelModal }}>
    ...
    <div className="about-modal-content">
      <div className="about-modal-title">
        <T id="aboutModal.decrediton" m="Pfcredit" />
      </div>
    ...
    <div className="about-modal-bottom-area">
      <div className="about-modal-bottom-area-left">
        ...
        {updateAvailable ?
          <a className="about-modal-upgrade" onClick={() => shell.openExternal("https://github.com/decred/picfight-binaries/releases")}><T id="aboutModal.upgradeAvailable" m="Upgrade Available"/></a> :
          <a className="about-modal-upgrade" onClick={() => shell.openExternal("https://github.com/decred/picfight-binaries/releases/tag/v1.3.0")}><T id="aboutModal.whatsNew" m="What's New?"/></a> }
      </div>
