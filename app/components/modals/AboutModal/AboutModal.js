      ...
      <Modal className="about-modal" {...{ show, onCancelModal }}>
        ...
        <div className="about-modal-content">
          ...
          <div className="about-modal-text-paragraph">
            <T id="aboutModal.paragraph1" m="A cross platform GUI Wallet for PicFight Coin written in node.js using Electron"/>
          </div>
          <div className="about-modal-text-paragraph">
            <T id="aboutModal.paragraph2a" m="Pfcredit is free and open source software, developed and designed by the global team of"/> <a onClick={() => shell.openExternal("http://picfight.org/contributors/")}><T id="aboutModal.paragraph2b" m="PicFight Coin contributors"/></a>
          </div>
          <div className="about-modal-text-paragraph">
        ...
        <div className="about-modal-bottom-area">
          ...
          <div className="about-modal-bottom-area-middle">
            Copyright &copy; 2018 <a onClick={() => shell.openExternal("https://picfight.org")}>Decred</a>
          </div>
