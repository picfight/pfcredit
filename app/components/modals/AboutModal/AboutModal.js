      ...
      <Modal className="about-modal" {...{ show, onCancelModal }}>
        ...
        <div className="about-modal-bottom-area">
          <div className="about-modal-bottom-area-left">
            ...
            {updateAvailable ?
              <a className="about-modal-upgrade" onClick={() => shell.openExternal("https://github.com/picfight/picfight-binaries/releases")}><T id="aboutModal.upgradeAvailable" m="Upgrade Available"/></a> :
              <a className="about-modal-upgrade" onClick={() => shell.openExternal("https://github.com/picfight/picfight-binaries/releases/tag/v"+`${version}`)}><T id="aboutModal.whatsNew" m="What's New?"/></a> }
          </div>
