...
export const SendTabHeader = service(({ isTestNet }) =>
  <DescriptionHeader
    description={isTestNet
      ...
      : <T id="transactions.description.send.mainnet" m={"Mainnet PicFight Coin addresses always begin with letter J and contain 26-35 alphanumeric characters\n(e.g. JxxXXXXXxXXXxXXXXxxx0XxXXXxxXxXxX0X)."} />}
  />);
