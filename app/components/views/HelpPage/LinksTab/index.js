  ...
  <Aux>
    ...
    <div className="help-icons-list">
      ...
      <HelpLinkInfoModal className={"help-constitution-icon"}
        ...
        subtitle={<T id="help.constitution.subtitle" m="PicFight Coin Project Constitution"/>}
        modalTitle={<h1><T id="help.constitution.modal.title" m="PicFight Coin Constitution" /></h1>}
