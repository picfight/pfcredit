...
export const LinksTab = () => (
  <Aux>
    ...
    <div className="help-icons-list">
      ...
      <HelpLink className={"help-forum-icon"} href="https://vk.com/picfight" title={<T id="help.vk" m="VK" />} subtitle={<T id="help.vk.subtitle" m="vk.com/picfight"/>}/>
    </div>

    <div className="tabbed-page-subtitle"><T id="help.subtitle.project" m="Project Related"/></div>
    <div className="help-icons-list">
      <HelpLink className={"help-github-icon"} href="https://github.com/picfight/pfcredit/issues" title={<T id="help.github.title" m="Github"/>} subtitle={<T id="help.github.subtitle" m="github.com/picfight/"/>} />
