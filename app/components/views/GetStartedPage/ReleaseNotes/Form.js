  ...
  <div className="page-body getstarted">
    <div className="getstarted loader logs">
      <div className="content-title">
        ...
        <T id="getStarted.logsTitle" m="Pfcredit v{version} Released" values={{ version: (appVersion) }}/>
      </div>
      <div className="release-notes">
        <div className="release-notes-text">
          <p>
            This release of Pfcredit marks the dawn of a large milestone in development.
            SPV (simple payment verification) has been added in pfcwallet which allows
          ...
          <p>
            ...
            as well as providing more feedback from pfcwallet to Pfcredit to make a richer
            user experience.
          </p>
          <p>
            *Note: Automatic ticket purchasing has been disabled for SPV.  We will be
            implementing a way to start and stop the new v2 ticketbuyer in pfcwallet.  This
          ...
          <ul>
            ...
            that will handle everything within pfcwallet.  This will lead to much less
